...
<%@ Import NameSpace="System.Threading" %> 
                          ...
                          <div id="wb-main" role="main"> 
                            <div id="wb-main-in">
                                ...
                                <div id="wb-cont">
                                                ...
                                                <h1><SharePointWebControls:FieldValue id="PageTitle" FieldName="Title" runat="server"/></h1>
 ...
 <asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server"> 
       <PublishingWebControls:EditModePanel runat="server" PageDisplayMode="Display">                              
                                ...
                                <div class="span-8">
	                                <div class="span-6">
		                                    <PublishingWebControls:RichHtmlField ID="RichHtmlField3" FieldName="PublishingPageContent" HasInitialFocus="True" MinimumEditHeight="400px" runat="server"/>
	                                </div>
		                        </div>
