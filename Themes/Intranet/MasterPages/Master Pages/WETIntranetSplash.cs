...
namespace WET.Theme.GCWU.Master_Pages
{
    public class WETSplash : MasterPage
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                string scriptRegex18ReplaceString = "onmouseover=\"this.src='\u002f_layouts\u002fimages\u002fgosearchhover15.png'\" onfocus=\"this.src='\u002f_layouts\u002fimages\u002fgosearchhover15.png'\" " +
                                                    "onmouseout=\"this.src='\u002f_layouts\u002fimages\u002fgosearch15.png'\" onblur=\"this.src='\u002f_layouts\u002fimages\u002fgosearch15.png'\" class=\"srch-gosearchimg\"";
                ...
                Regex scriptRegex24 = new Regex("<div id=\"cn-bc-inner\"><span><ol>");
                MatchCollection scriptMatches24 = scriptRegex24.Matches(html);
                // go through matches in reverse 
                for (int i = scriptMatches24.Count - 1; i >= 0; i--)
                {
                    html = html.Replace(scriptMatches24[i].Value, "<div id=\"cn-bc-inner\"><ol>");
                }

                // clean the span outputted by SP when adding breadcrumbs <div id="cn-bc-inner"><span><ol> and </span></div><!-- cn-bc-inner -->
                Regex scriptRegex25 = new Regex("</span></div><!-- cn-bc-inner -->");
                MatchCollection scriptMatches25 = scriptRegex25.Matches(html);
                // go through matches in reverse 
                for (int i = scriptMatches25.Count - 1; i >= 0; i--)
                {
                    html = html.Replace(scriptMatches25[i].Value, "</div><!-- cn-bc-inner -->");
                }
                ...
                Regex scriptRegex26 = new Regex("WebPartid=\"00000000-0000-0000-0000-000000000000\" HasPers=\"true\"");
                ...
                Regex scriptRegex27 = new Regex("OnlyForMePart=\"true\" allowDelete=\"false\"");
