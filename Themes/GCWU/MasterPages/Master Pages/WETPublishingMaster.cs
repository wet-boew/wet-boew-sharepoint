...
{
    public class WETPublishingMaster : MasterPage
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            {
                WET.Theme.GCWU.Objects.Logger.WriteLog("WETPublishingMasterPage.cs error in Render method: " + ex.Message);
            }
        }
