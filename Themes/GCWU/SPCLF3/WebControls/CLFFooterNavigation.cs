...
{
    [ToolboxData("<{0}:CLFFooterNavigation runat=\"server\" />")]
    public class CLFFooterNavigation : WebControl
    {
                    ...
                    if (PublishingPage.IsPublishingPage(SPContext.Current.ListItem))
                    {
                        ...
                        try
                        {
                            ...
                            using (SPSite site = new SPSite(webUrl))
                            {
                                ...
                                {
                                    cLFFooterNavigation = web.Lists["CLF3FooterNavigation"];
                                    ...
                                    if (cLFFooterNavigation != null)
                                    {
                                        ...
                                        foreach (SPListItem item in collListItems)
                                        {
                                            ...
                                            if (item.Title.ToLower() == HttpContext.GetGlobalResourceObject("CLF3", "TermsAndConditionsText", SPContext.Current.Web.Locale).ToString().ToLower())
                                            {
                                                linkRel = " rel=\"license\"";
                                            }
                                            else
