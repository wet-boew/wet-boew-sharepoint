    ...
    <div id="cont" class="center">
        <div class="span-6">
            ...
            <div style="float:left !important; width:100% !important;">
                <div style="width:25% !important; float:right !important;">
                    <WebPartPages:WebPartZone runat="server" FrameType="None" ID="WPZoneFloatRight" title="WPZoneFloatRight" />
                </div>
                <PublishingWebControls:RichHtmlField ID="RichHtmlField1" FieldName="PublishingPageContent" HasInitialFocus="True" MinimumEditHeight="400px" runat="server" PrefixStyleSheet="WET"></PublishingWebControls:RichHtmlField>                
            </div>
...
<asp:Content ContentPlaceholderID="PlaceHolderLastModifiedDate" runat="server"><CLFCustomControls:LastModifiedDate runat="server"></CLFCustomControls:LastModifiedDate>
</asp:Content>
