...
{
    /// <WET4Changes>
    ///     2014-11-24 This file required renaming of CLF3 to WET4, no other change required as it generates only metatags  - BARIBF
    /// </WET4Changes>
        ...
        private string ReplaceDefaultContent(string parameter)
        {
            ...
            switch (parameter)
            {
                ...
                case "@servername":
                    ...
                    break;
                case "@SiteTitle":
                    defaultContent = HttpContext.GetGlobalResourceObject("WET4", "SiteTitleText", SPContext.Current.Web.Locale).ToString();
                    break;
                default:
