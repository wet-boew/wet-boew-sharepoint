...
<asp:Content ContentPlaceholderID="PlaceHolderLeftNavBar" runat="server">
	<nav id="wb-sec" class="col-md-3 col-md-pull-9 visible-md visible-lg" typeof="SiteNavigationElement" role="navigation">
        ...
        <WETCustomControls:WETLeftNavigation ID="WETLeftNavigation1" runat="server" />
    </nav>
...
<asp:Content ContentPlaceholderID="PlaceHolderLastModifiedDate" runat="server">
	<WETCustomControls:LastModifiedDate runat="server"></WETCustomControls:LastModifiedDate></asp:Content>