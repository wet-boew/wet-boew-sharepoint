...
{
    /// <WET4Changes>
    ///     2014-11-24 This Web Control does not need to be adjusted for WET4 as it only renders the required javascript block for Google Analytics.  -MD
    /// </WET4Changes>
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            if (this.RenderTrackingCode)
            {
                ...
                else if (this.Location == TrackingCodeLocation.Body)
                {
                    ...
                    writer.WriteLine("<script src=\"/_layouts/SPWET4/webtrends/js/webtrends.js\" type=\"text/javascript\"></script>");
