        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            try
            {
                ...
                if (SPContext.Current.ListItem != null && PublishingPage.IsPublishingPage(SPContext.Current.ListItem))
                {
                    ...
                    {
                        Master_Pages.WET4PublishingMaster masterPage = (Master_Pages.WET4PublishingMaster)this.Page.Master;
                    ...
                    if (label == null)
                    {
                        ...
                        string langlabel = HttpContext.GetGlobalResourceObject("WET4", "OtherLanguageText", SPContext.Current.Web.Locale).ToString();
                    ...
                    else
                    {
                        ...
                        if (label == null)
                        {
                            throw new System.ArgumentException(HttpContext.GetGlobalResourceObject("WET4", "Error_CantFindPubWebLabel", SPContext.Current.Web.Locale).ToString(), "listItem");
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    string Languagecontrol = "";
                    if (currentLang.Equals("en"))
                        Languagecontrol = "<a href=\"" + url.ToLower().Replace("/eng/", "/fra/") + queryString + "\" lang=\"" + currentLang + "\" xml:lang=\"" + currentLang + "\" onclick=\"javascript:OnSelectionChange(1036); return false;\"><span>" + langlabel + "</span></a>";
                    else
                        Languagecontrol = "<a href=\"" + url.ToLower().Replace("/fra/", "/eng/") + queryString + "\" lang=\"" + currentLang + "\" xml:lang=\"" + currentLang + "\" onclick=\"javascript:OnSelectionChange(1033); return false;\"><span>" + langlabel + "</span></a>";
                    this.Controls.Add(new LiteralControl(Languagecontrol));
                }
            }
            catch (Exception ex)
