...
// Created: 8/30/2012 3:33:50 PM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = "dcsbicp4b100004n4y0dqb5li_6e9v";
    this.domain = "webtrends2.collectionscanada.gc.ca";
    this.timezone = -5;
    this.onsitedoms = "";
    this.downloadtypes = "xls,doc,pdf,txt,csv,zip,docx,xlsx,mp3,xml";
