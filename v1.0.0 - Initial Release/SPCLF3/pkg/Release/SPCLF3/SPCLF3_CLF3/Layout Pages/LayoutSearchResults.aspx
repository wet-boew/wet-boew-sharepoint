...
<asp:Content ContentPlaceholderID="PlaceHolderLeftNavBar" runat="server">
    <div id="cn-left-col"><!-- cn-left-col -->
        <div id="cn-left-col-inner"><!-- cn-left-col-inner -->
            <nav role="navigation" >
                <h2 id="cn-nav"><asp:Literal Text="<%$Resources:CLF3, PrimaryNavigationHeaderText%>" runat="server" /></h2>
                <div class="cn-left-col-default WebCorp_SearchResults_LeftColumn"><!-- cn-left-col-default -->
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
    <div id="cont" class="center">
        <div class="span-6 WebCorp_SearchResults_PageContent">
