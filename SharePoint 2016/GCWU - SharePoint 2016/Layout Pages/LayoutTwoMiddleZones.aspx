<%@ Page language="C#"   Inherits="SPWET4.Layout_Pages.LeftNavigationBaseLayout,SPWET4, Version=1.0.0.0, Culture=neutral, PublicKeyToken=e515e573c8cc4469" meta:progid="SharePoint.WebPartPage.Document" meta:webpartpageexpansion="full" %>
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	<section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <WebPartPages:WebPartZone runat="server" ID="TopZone" Title="Top Zone">
            ...
            <div class="row">
                <div class="col-md-6">
            	    <WebPartPages:WebPartZone runat="server" ID="MiddleSidebarZone" Title="Middle Left Zone">
                        <ZoneTemplate></ZoneTemplate>
            	    </WebPartPages:WebPartZone>
                </div>
            
                <div class="col-md-6">
            	    <WebPartPages:WebPartZone runat="server" ID="MiddleContentZone" Title="Middle Right Zone">
                        <ZoneTemplate></ZoneTemplate>
            	    </WebPartPages:WebPartZone>
                </div>
            </div>
